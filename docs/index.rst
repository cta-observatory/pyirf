.. pyrf documentation master file, created by
...
pyrf can:
  ...
  * find the best cutoff in gammaness/score, to discriminate between signal
    ...
    source of interest (:ref:`pyrf`)
  * compute the instrument response functions, effective area,
    point spread function and energy resolution (:ref:`pyrf`)
  * estimate the sensitivity (:ref:`pyrf`)
